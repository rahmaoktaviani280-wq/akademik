        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <input type="JenisKelamin" id="inputPassword5" class="form-control" aria-describedby="JenisKeaminHelpBlock">
                    <div id="JenisKlaminHelpBlock" class="form-text"></div>
                 </form>
                 <button class="btn btn-primary"></i>simpan data</button>
                </div>
